  ...
  programs.aerospace = lib.mkIf pkgs.stdenv.isDarwin {
    ...
    settings = {
      ...
      mode.main.binding = {
        ...
        "alt-a" = "workspace A"; "alt-2" = "workspace B"; "alt-1" = "workspace C"; 
        "alt-4" = "workspace D"; "alt-5" = "workspace G"; "alt-6" = "workspace M"; 
        "alt-n" = "workspace N"; "alt-r" = "workspace R"; "alt-s" = "workspace S"; 
        "alt-t" = "workspace T"; "alt-3" = "workspace V"; "alt-w" = "workspace W"; 
        "alt-x" = "workspace X"; 

        # Move to Workspaces
        "alt-shift-a" = "move-node-to-workspace A"; "alt-shift-2" = "move-node-to-workspace B";
        "alt-shift-1" = "move-node-to-workspace C"; "alt-shift-d" = "move-node-to-workspace D";
        "alt-shift-g" = "move-node-to-workspace G"; "alt-shift-m" = "move-node-to-workspace M";
        "alt-shift-n" = "move-node-to-workspace N"; "alt-shift-r" = "move-node-to-workspace R";
        "alt-shift-s" = "move-node-to-workspace S"; "alt-shift-t" = "move-node-to-workspace T";
        "alt-shift-3" = "move-node-to-workspace V"; "alt-shift-w" = "move-node-to-workspace W";
      ...
      workspace-to-monitor-force-assignment = {
        W = 1; C = "secondary"; V = "main"; B = "main"; S = "main";
      };
